# Originally located in https://github.com/sisl/TaskGraphs.jl/tree/master but not exported.
# This file appeared to only be used here, so I pulled it to this repo.
